...
/* ================================================= */
/* 👽 CÓDIGO NUEVO — ALIENS ANIMADOS (NO TOCAR ARRIBA) */
/* ================================================= */
...
top: 65%;
left: -120px;
animation: fly3 26s linear infinite;
}
...
to { transform: translateX(120vw) translateY(-80px); }
}
...
<!-- 👽 CAPA DE ALIENS (AGREGADO) -->
<div class="alien-layer">
<div class="alien-ship ship-1"></div>
<div class="alien-ship ship-2"></div>
<div class="alien-ship ship-3"></div>
</div>
...
automatización y tecnologías del futuro.
</p>
</section>
...
<p>Un entorno visual inspirado en el espacio y la evolución de la IA.</p>
